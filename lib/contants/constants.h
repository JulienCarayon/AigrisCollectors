...
#define ATTACKER_DISTANCE_FOLLOWER_SHIP 2000
#define EXPLORER_DISTANCE_FOLLOWER_SHIP 500

#define MOVE_CMD_ANGLE_THRESHOLD 2
#define FOLLOW_SHIP_SPEED_DISTANCE_THRESHOLD 500

#define PLACE_HOLDER_FOLLOWING_MAX_SPEED 4000

#define FIRE_DISTANCE 5000
